...
import ru.inversion.sbpapplication.databinding.FragmentTerminalListBinding
import ru.inversion.sbpapplication.pojo.Customer


class TerminalListFragment : Fragment() {

    private var bindin: FragmentTerminalListBinding? = null
    ...
    override fun onCreateView(
        ...
        bindin = FragmentTerminalListBinding.inflate(inflater, container, false)
        return bindin?.root
    }
