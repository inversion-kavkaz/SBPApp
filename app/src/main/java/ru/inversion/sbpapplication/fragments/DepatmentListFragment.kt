...
class DepatmentListFragment : Fragment() {
    private var bindin: FragmentDepatmentListBinding? = null
    ...
    override fun onCreateView(
        ...
        bindin = FragmentDepatmentListBinding.inflate(inflater, container, false)
        return bindin?.root
    }
